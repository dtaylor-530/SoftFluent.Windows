...
namespace SoftFluent.Windows {
   public class PropertyGridProperty :  AutoObject, IPropertyGridProperty, IComparable, IComparable<PropertyGridProperty> {
      ...
      public PropertyGridProperty(PropertyGridListSource listSource, IActivator activator) {
         if (listSource == null) {
      ...
      public object BuildItems(Type targetType, object parameter, CultureInfo culture)
      {
         var items = Helper5.BuildItems(_activator, this, targetType, parameter, culture);
