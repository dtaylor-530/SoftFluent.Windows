...
namespace SoftFluent.Windows
{
    ...
    public abstract class AutoObject : IDataErrorInfo, INotifyPropertyChanged, IKey, IObserver
    {
        ...
        //[XmlIgnore]
        //[Browsable(false)]
        //public virtual bool RaisePropertyChanged { get; set; } = true;
        ...
        //[XmlIgnore]
        //[Browsable(false)]
        //public virtual bool ThrowOnInvalidProperty { get; set; } = true;
        ...
        protected virtual T GetProperty<T>([CallerMemberName] string? name = null)
        {
            ...
            //{
            //    defaultValue = ConversionHelper.ChangeType<T>(obj);
            //}
            //else
            //{
            ...
            //    defaultValue = att != null ? ConversionHelper.ChangeType(att.Value, default(T)) : default(T);
        ...
        //    return PropertyStore.GetValue<T>(new Key(this.guid, name));
        //}
        ...
        ///// true if the value has changed; otherwise false.
        ///// </returns>
        //public virtual bool SetProperty(string name, object value, bool setChanged, bool forceRaise, bool trackChanged)
        //{
        //    if (name == null)
        //    {
        //        throw new ArgumentNullException("name");
        ...
        //    //bool hasOldValue = propertyStore.GetValue<T>(new Key(this.guid, name));
