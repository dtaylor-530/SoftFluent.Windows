...
namespace SoftFluent.Windows {
   ...
   public class PropertyGridListSource : IPropertyGridListSource, IListSource {
      private readonly ActivatorHelper _activatorHelper;
      ...
      public PropertyGridListSource(ActivatorHelper  activatorHelper, IPropertyGrid grid, object data, int inheritanceLevel = 0) {
         _activatorHelper = activatorHelper;
      ...
      public virtual DynamicObject CreateDynamicObject() {
         return _activatorHelper.CreateInstance<DynamicObject>();
      }

      public virtual PropertyGridProperty CreateProperty() {
         return _activatorHelper.CreateInstance<PropertyGridProperty>(this);
      }
