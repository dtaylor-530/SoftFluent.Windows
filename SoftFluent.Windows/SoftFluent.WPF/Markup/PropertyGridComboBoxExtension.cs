       ...
       static PropertyGridComboBoxExtension()
       {
        ...
        protected class Converter : IValueConverter
        {
            ...
            public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
            {
                ...
                if (property != null)
                {
                    return Extension.BuildItems(_activatorHelper,property, targetType, parameter, culture);
                }
        ...
        private static readonly ActivatorHelper _activatorHelper;
        ...
        public static object EnumToObject(PropertyGridProperty property, object value)
        {
            ...
            IPropertyGridOptionsAttribute options = PropertyGridOptionsAttribute.FromProperty(property);
            if (options == null)
            {
                return ConversionHelper.ChangeType(value, property.PropertyType);
            }
        ...
        public static ulong EnumToUInt64(PropertyGridProperty property, object value)
        {
            ...
            IPropertyGridOptionsAttribute att = PropertyGridOptionsAttribute.FromProperty(property);
        ...
        public virtual IEnumerable BuildItems(ActivatorHelper _activatorHelper, PropertyGridProperty property, Type targetType, object parameter, CultureInfo culture)
        {
            if (property == null)
            {
                throw new ArgumentNullException("property");
            ...
            property.OnEvent(this, _activatorHelper.CreateInstance<PropertyGridEventArgs>(property, ctx));
            return items;
          PropertyGridItem CreateItem() {
           return _activatorHelper.CreateInstance<PropertyGridItem>();
        }
        }
